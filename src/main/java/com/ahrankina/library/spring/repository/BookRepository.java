...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    @Query("select new com.ahrankina.library.domain.Book(b.id, b.name, b.pageCount, b.isbn, b.genre, b.author, b.publisher, " +
    ...
    @Query("select new com.ahrankina.library.domain.Book(b.id, b.image) from Book b")
    ...
    @Modifying
    @Query("update Book b set b.totalVoteCount=:totalVoteCount, b.totalRating=:totalRating, b.avgRating=:avgRating " +
            "where b.id =:id")
